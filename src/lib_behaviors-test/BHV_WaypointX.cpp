...
BHV_WaypointX::BHV_WaypointX(IvPDomain gdomain) : 
  IvPBehavior(gdomain)
{
...
void BHV_WaypointX::onSetParamComplete()
{
...
bool BHV_WaypointX::setParam(string param, string param_val) 
{
...
void BHV_WaypointX::onIdleToRunState() 
{
  if(!updateInfoIn()) 
    return;
  m_odo_leg_disq = true;
...
void BHV_WaypointX::onRunToIdleState() 
{
  postErasables();
...
BehaviorReport BHV_WaypointX::onRunState(string input) 
{
...
IvPFunction *BHV_WaypointX::onRunState() 
{
...
void BHV_WaypointX::onIdleState() 
{
  if(!updateInfoIn()) 
    return;
}
...
bool BHV_WaypointX::updateInfoIn()
{
...
bool BHV_WaypointX::setNextWaypoint()
{
...
IvPFunction *BHV_WaypointX::buildOF(string method) 
{
  IvPFunction *ipf = 0;
...
void BHV_WaypointX::postStatusReport()
{
  int    current_waypt = m_waypoint_engine.getCurrIndex();
...
void BHV_WaypointX::postViewableSegList()
{
...
void BHV_WaypointX::postErasables()
{
  postMessage("VIEW_POINT", m_trackpt.get_spec("active=false"), "trk");
  postMessage("VIEW_POINT", m_nextpt.get_spec("active=false"), "wpt");
...
void BHV_WaypointX::postCycleFlags()
{
...
void BHV_WaypointX::postWptFlags(double x, double y)
{
...
void BHV_WaypointX::handleVisualHint(string hint)
{
...
void BHV_WaypointX::checkLeadConditions()
{
  if(!m_info_buffer) 
    return;
...
void BHV_WaypointX::updateOdoDistance()
{
  if(!m_odo_virgin) {
